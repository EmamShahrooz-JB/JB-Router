 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what jb-router needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a jb-router
 ...
 * The suffix is a jb-router request override, not part of Kiro's upstream model id.
 */
...
/**
 * Detect whether a model id refers to a jb-router synthetic agentic variant.
...
/**
 * Detect whether a model id is a jb-router synthetic thinking variant
...
/**
 * Resolve a jb-router model id to the real upstream Kiro model id, plus flags
