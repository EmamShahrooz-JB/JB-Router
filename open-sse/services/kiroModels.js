 ...
 * into jb-router-shaped variants:
 *
 *   {upstream}                          - base model
 ...
 * API. They are jb-router fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic jb-router variant set for a single upstream Kiro model.
 *
 ...
 * into jb-router variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
