...
const APP_LABEL = "com.jb-router.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when jb-router is currently
 ...
 * SIGTERM to the running process. When the running jb-router cli.js was itself
...
<dict>
    ...
    <string>/tmp/jb-router.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/jb-router.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `jb-router.cmd` lookup that depended on the npm prefix path.
