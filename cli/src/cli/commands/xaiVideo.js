/**
 * `jb-router xai video` — generate a Grok Imagine video through the local
 * jb-router gateway and save the result as an MP4 file.
 *
...
const HELP = `
Usage: jb-router xai video --prompt "..." [options]

Generate a Grok Imagine video via your local jb-router gateway
...
Options:
  ...
  --api-key <key>         jb-router API key (or env NINE_ROUTER_API_KEY)
...
async function run(argv) {
  ...
  try {
    ...
    const connectionId = create.headers["x-jb-router-connection-id"] || null;
