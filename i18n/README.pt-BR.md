<div align="center">
  <img src="../images/jb-router.png?2" alt="Painel do JB-Router" width="800"/>
  
  # JB-Router — roteador de IA GRATUITO e economizador de tokens
  ...
  **Conecte todas as ferramentas de código de IA (Claude Code, Cursor, Antigravity, Copilot, Codex, Gemini, OpenCode, Cline, OpenClaw...) a mais de 40 provedores de IA e mais de 100 modelos.**
  ...
  [![Licença](https://img.shields.io/github/license/EmamShahrooz-JB/JB-Router)](github.com/EmamShahrooz-JB/JB-Router/blob/main/LICENSE)
...
[🚀 Início rápido](#-início-rápido) • [💡 Recursos](#-principais-recursos) • [📖 Configuração](#-guia-de-configuração) • [🌐 Site](https://github.com/EmamShahrooz-JB/JB-Router)
...
└──────┬──────┘
       ...
       ↓
┌─────────────────────────────────────────────┐
│           JB-Router (Roteador inteligente)            │
...
Este pacote de repositório é privado (`jb-router-app`), portanto, a execução pelo código-fonte/Docker é o caminho de desenvolvimento local esperado.
  ...
  <tr>
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=X69n5Lm06Yw">
        <img src="https://img.youtube.com/vi/X69n5Lm06Yw/maxresdefault.jpg" alt="Tiết kiệm chi phí LLM với JB-Router" width="300"/>
</a><br/>
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Tiết kiệm chi phí LLM cho OpenClaw no JB-Router<br/>por <a href="https://www.youtube.com/c/M%C3%ACAIblog">Mì AI</a></sub>
    </td>
    <td align="center" width="320">
      <a href="https://youtu.be/VQAw612S27Y">
        <img src="https://img.youtube.com/vi/VQAw612S27Y/maxresdefault.jpg" alt="JB-Router + Claude Code FREE Unlimited Setup" width="300"/>
      </a><br/>
      <b>🇵🇰 اردو / हिन्दी</b><br/>
      <sub>JB-Router + Claude Code Configuração ilimitada GRATUITA<br/>por <a href="https://www.youtube.com/@BuildAIWithHamid">Construir IA com Hamid</a></sub>
    </td>
    <td align="center" width="320">
<a href="https://www.youtube.com/watch?v=raEyZPg5xE0">
        <img src="https://img.youtube.com/vi/raEyZPg5xE0/maxresdefault.jpg" alt="JB-Router Setup Tutorial" width="300"/>
      </a><br/>
      <b>🇺🇸 Inglês</b><br/>
      <sub>JB-Router + Claude Code Configuração GRATUITA<br/>por <a href="https://www.youtube.com/@BuildAIWithHamid">Construir IA com Hamid</a></sub>
    </td>
    <td align="center" width="320">
      <a href="https://youtu.be/3dF5GIYMrcQ?si=bAyfyiHbARJQAHj_">
        <img src="https://img.youtube.com/vi/3dF5GIYMrcQ/hqdefault.jpg" alt="JB-Router Setup Tutorial" width="300"/>
      </a><br/>
      <b>🇺🇸 Inglês</b><br/>
      <sub>JB-Router + Claude Code Configuração GRATUITA<br/>por <a href="https://www.youtube.com/@BuildAIWithHamid">Construir IA com Hamid</a></sub>
</td>
...
<img src="https://img.youtube.com/vi/Ttpc26m39Dw/maxresdefault.jpg" alt="Claude CLI Free Setup" width="300"/>
      ...
      <b>🇺🇸 Inglês</b><br/>
      Configuração gratuita <sub>Claude CLI com JB-Router 🚀<br/>por <a href="https://www.youtube.com/@CodeVerseSoban">CodeVerse Soban</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Cài Đặt OpenClaw Free Từ A-Z + JB-Router<br/>por <a href="https://www.youtube.com/@maigia">Mai Gia</a></sub>
    </td>
<td align="center" width="320">
    ...
    <td align="center" width="320">
      ...
      <b>🇮🇩 Indonésia</b><br/>
<sub>Koding 24 Jam Anti Rate Limit! Hemat Token AI 65% | Tutorial Configuração Rápida JB-Router 🚀<br/>por <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=TXGv4eofe1I">
        <img src="https://img.youtube.com/vi/TXGv4eofe1I/mqdefault.jpg" alt="Cara Deploy JB-Router di Hugging Face GRATIS Non-Stop! | Alternatif VPS RAM 16GB" width="300"/>
      </a><br/>
      <b>🇮🇩 Indonésia</b><br/>
      <sub>Cara Implante JB-Router no Hugging Face GRATUITAMENTE sem parar! | Alternativa VPS RAM 16GB<br/>por <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="320">
<a href="https://www.youtube.com/watch?v=GyX-DLvePW8">
    ...
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=hPusYX-5Pmw">
        <img src="https://img.youtube.com/vi/hPusYX-5Pmw/maxresdefault.jpg" alt="Hướng Dẫn Setup OpenClaw + JB-Router: Tạo Bot Zalo AI Tự Động Từ A-Z" width="300"/>
      </a><br/>
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Hướng Dẫn Setup OpenClaw + JB-Router: Tạo Bot Zalo AI Tự Động Từ A-Z<br/>por <a href="https://github.com/tuanminhhole">tuanminhhole</a></sub>
</td>
...
> 🎬 **Fez um vídeo sobre o JB-Router?** Envie um [Pull Request](github.com/EmamShahrooz-JB/JB-Router/pulls) adicionando seu vídeo a esta seção - nós o mesclaremos!

---

## 🛠️ Ferramentas CLI suportadas

JB-Router funciona perfeitamente com todas as principais ferramentas de codificação de IA:
...
Configure `X-JB-Router-Token-Saver: off` para ignorar todos os economizadores de tokens para uma solicitação de chat.
...
O headroom é opcional e funciona separadamente. JB-Router chama o endpoint `/v1/compress` local do Headroom e, em seguida, mantém roteamento normal, fallback, autenticação e rastreamento de uso:

```
Cliente → JB-Router → Headroom /v1/compress → JB-Router → provedor
```
...
Se o Headroom estiver inativo ou retornar um erro, o o JB-Router seguirá em modo aberto e enviará a solicitação original.
...
- Sua ferramenta CLI envia formato OpenAI → JB-Router traduz → Provedor recebe formato nativo
...
> O próprio JB-Router **nunca cobra** nada. Você paga apenas aos provedores diretamente (se usar serviços pagos).
>
...
> roteamento através do JB-Router!
...
### 📊 Compreendendo os custos e faturamento do JB-Router

**Como funciona o faturamento do JB-Router:**

✅ **Software JB-Router = GRATUITO para sempre** (código aberto, nunca cobra)  
...
❌ **JB-Router nunca envia faturas** ou cobra seu cartão
...
- **Provedores baratos** (GLM, MiniMax): pague diretamente, JB-Router apenas roteia
- **Provedores GRATUITOS** (iFlow, Kiro, Qwen): Genuinamente grátis para sempre, sem taxas ocultas
- **JB-Router**: Nunca cobra nada
...
O painel rastreia o uso do token e exibe **custos estimados** como se você estivesse usando APIs pagas diretamente. Este **não é faturamento real** - é uma referência para mostrar quanto você está economizando usando modelos gratuitos ou assinaturas existentes através do JB-Router.
...
<details>
<summary><b>💳 Serei cobrado pelo JB-Router?</b></summary>

**Não.** JB-Router é um software gratuito e de código aberto que roda em seu próprio computador. Nunca cobra nada.

**Você só paga:**

- ✅ **Provedores de assinatura** (Claude Code $20/mo, Codex $20-200/mo) → Pague-os diretamente em seus sites
- ✅ **Provedores baratos** (GLM, MiniMax) → Pague diretamente, JB-Router apenas encaminha suas solicitações
- ❌ **JB-Router em si** → **Nunca carrega nada, nunca**

JB-Router é um proxy/roteador local. Não possui cartão de crédito, não pode enviar faturas e não possui sistema de cobrança. É um software totalmente gratuito.
...
O JB-Router apenas encaminha suas solicitações para eles - não há pegadinhas ou cobrança futura do próprio JB-Router. Eles são serviços verdadeiramente gratuitos e o JB-Router os torna fáceis de usar com suporte alternativo.
...
- JB-Router ajuda a maximizar seu valor por meio do rastreamento de cotas
...
O fallback inteligente do JB-Router evita cobranças surpresa:
...
**Você está no controle:** Defina limites de gastos por provedor no painel e o JB-Router os respeita.
...
**Dica profissional:** Use o Opus para tarefas complexas e o Sonnet para velocidade. JB-Router rastreia cota por modelo!
...
Configurações → Modelos → Avançado:
  ...
  OpenAI API Key: [copie do painel do JB-Router]
...
```json
{
  ...
  "anthropic_api_key": "your-jb-router-api-key"
}
```
...
export OPENAI_API_KEY="your-jb-router-api-key"
...
```json
{
  "agents": {
    "defaults": {
      "model": {
        "primary": "jb-router/kr/claude-sonnet-4.5"
      }
    }
  },
  "models": {
...
> **Nota:** OpenClaw só funciona com JB-Router local. Use `127.0.0.1` em vez de `localhost` para evitar problemas de resolução IPv6.
...
export DATA_DIR="/var/lib/jb-router"
export PORT="20128"
export HOSTNAME="0.0.0.0"
export NODE_ENV="production"
export NEXT_PUBLIC_BASE_URL="http://localhost:20128"
export NEXT_PUBLIC_CLOUD_URL="https://github.com/EmamShahrooz-JB/JB-Router"
...
# Ou usar PM2
npm install -g pm2
pm2 start npm --name jb-router -- start
pm2 save
pm2 startup
```
...
- Hub Docker: [`EmamShahrooz-JB/JB-Router`](https://github.com/EmamShahrooz-JB/JB-Router)
- GHCR: [`ghcr.io/EmamShahrooz-JB/JB-Router`](github.com/EmamShahrooz-JB/JB-Router/pkgs/container/jb-router)
...
docker run -d --name jb-router -p 20128:20128 \
  -v "$HOME/.jb-router:/app/data" -e DATA_DIR=/app/data jb-router
```
...
```bash
docker logs -f jb-router
docker restart jb-router
docker stop jb-router && docker rm jb-router
docker pull EmamShahrooz-JB/JB-Router:latest   # atualizar para a versão mais recente
```

**Persistência de dados:** `$HOME/.jb-router/db/data.sqlite` no host ↔ `/app/data/db/data.sqlite` no contêiner.

### Variáveis de Ambiente

| Variável | Padrão | Descrição |
| ---------------------------------------------------- | ---------------------------------------- | ----------------------------------------------------------------------------------- |
| `JWT_SECRET` | Gerado automaticamente (`~/.jb-router/jwt-secret`) | Segredo de assinatura JWT para cookie de autenticação do painel (substituir para compartilhar entre instâncias) |
| `INITIAL_PASSWORD` | `123456` | Primeira senha de login quando não existe hash salvo |
| `DATA_DIR` | `~/.jb-router` | Localização principal dos dados do aplicativo (SQLite em `$DATA_DIR/db/data.sqlite`) |
...
| `CLOUD_URL` | `https://github.com/EmamShahrooz-JB/JB-Router` | URL base do endpoint de sincronização na nuvem do lado do servidor |
...
| `NEXT_PUBLIC_CLOUD_URL` | `https://github.com/EmamShahrooz-JB/JB-Router` | URL de nuvem pública/compatível com versões anteriores (prefira `CLOUD_URL` para tempo de execução do servidor) |
...
- `${DATA_DIR}` e `~/.jb-router` resolvem para o mesmo local em um contêiner Docker — o link simbólico `/root/.jb-router -> /app/data` é criado no momento da construção.
...
- Atualizado automaticamente pelo JB-Router
...
- **Site**: [jb-router.com](https://github.com/EmamShahrooz-JB/JB-Router)
- **GitHub**: [github.com/EmamShahrooz-JB/JB-Router](github.com/EmamShahrooz-JB/JB-Router)
- **Issues**: [github.com/EmamShahrooz-JB/JB-Router/issues](github.com/EmamShahrooz-JB/JB-Router/issues)

---

## 👥 Colaboradores

Obrigado a todos os colaboradores que ajudaram a tornar o JB-Router melhor!

[![Contribuidores](https://contrib.rocks/image?repo=EmamShahrooz-JB/JB-Router&max=150&columns=15&anon=1&v=20260309)](github.com/EmamShahrooz-JB/JB-Router/graphs/contributors)

---

## 📊 Gráfico de estrelas

[![Gráfico de estrelas](https://starchart.cc/EmamShahrooz-JB/JB-Router.svg?variant=adaptive)](https://starchart.cc/EmamShahrooz-JB/JB-Router)

## 🔀 Forks

**[OmniRoute](https://github.com/diegosouzapw/OmniRoute)** — Um fork TypeScript completo do JB-Router. Adiciona mais de 36 provedores, fallback automático de 4 camadas, APIs multimodais (imagens, incorporações, áudio, TTS), disjuntor, cache semântico, avaliações LLM e um painel sofisticado. Mais de 368 testes de unidade. Disponível via npm e Docker.
...
- **[RTK](https://github.com/rtk-ai/rtk)** ![Stars](https://img.shields.io/github/stars/rtk-ai/rtk?style=flat&color=yellow) — Economizador de tokens em Rust. O JB-Router porta seu pipeline de compactação para JS → **−20-40% de tokens de entrada** em cada solicitação.
- **[Caveman](https://github.com/JuliusBrussee/caveman)** ![Stars](https://img.shields.io/github/stars/JuliusBrussee/caveman?style=flat&color=yellow) por **[@JuliusBrussee](https://github.com/JuliusBrussee)** — viral _"por que usar muitos tokens quando poucos tokens resolvem"_. JB-Router adapta seu prompt → **−65% tokens de saída**.
- **[Ponytail](https://github.com/DietrichGebert/ponytail)** ![Estrelas](https://img.shields.io/github/stars/DietrichGebert/ponytail?style=flat&color=yellow) por **[@DietrichGebert](https://github.com/DietrichGebert)** — _"desenvolvedor sênior preguiçoso"_ habilidade. JB-Router injeta sua abordagem YAGNI-first → **menos tokens, menos código, diferenças mais curtas**.

Um grande agradecimento a esses autores – sem o trabalho deles, os recursos de economia de tokens do JB-Router não existiriam. Dê uma ⭐ a eles no GitHub!
