...
The same matrix applies to jb-router's virtual `-review` variants because they
...
- Adding Codex Ultra's multi-agent orchestration behavior inside jb-router;
  jb-router only forwards the catalog-advertised reasoning override.
