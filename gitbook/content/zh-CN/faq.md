...
**JB-Router 是一款 AI 模型路由工具,能够最大化你的订阅价值并最小化成本。**
...
**是的,JB-Router 优先考虑安全和隐私:**

**本地存储:**
- 所有数据存储在本地 `~/.jb-router`(或自定义 `DATA_DIR`)
- 不会发送数据到 JB-Router 服务器
...
**破坏性变更:**
- 查看 [CHANGELOG.md](github.com/EmamShahrooz-JB/JB-Router/blob/main/CHANGELOG.md)
- 大版本更新前备份 `~/.jb-router`
- 阅读大版本的迁移指南
...
详情见 [CONTRIBUTING.md](github.com/EmamShahrooz-JB/JB-Router/blob/main/CONTRIBUTING.md)。
