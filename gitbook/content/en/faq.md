...
Common questions about JB-Router.

---

## What is JB-Router?

**JB-Router is an AI model router that maximizes your subscription value and minimizes costs.**
...
**JB-Router uses a 3-tier pricing strategy:**
...
**Yes, JB-Router itself is 100% free and open source.**
...
**Yes! This is JB-Router's core feature.**
...
**JB-Router tracks quota in real-time for all providers:**
...
## Can I self-host JB-Router?

**Yes! JB-Router supports multiple deployment options:**
...
- `DATA_DIR` - Database storage path (default: `~/.jb-router`)
...
**Yes, JB-Router prioritizes security and privacy:**

**Local storage:**
- All data stored locally in `~/.jb-router` (or custom `DATA_DIR`)
- No data sent to JB-Router servers
...
**What JB-Router stores:**
- Provider OAuth tokens (encrypted)
- API keys (encrypted)
- Usage statistics (local only)
- Combo configurations

**What JB-Router does NOT store:**
...
**Breaking changes:**
- Check [CHANGELOG.md](github.com/EmamShahrooz-JB/JB-Router/blob/main/CHANGELOG.md)
- Backup `~/.jb-router` before major updates
...
See [CONTRIBUTING.md](github.com/EmamShahrooz-JB/JB-Router/blob/main/CONTRIBUTING.md) for details.
