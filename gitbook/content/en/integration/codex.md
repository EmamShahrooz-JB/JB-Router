...
Integrate JB-Router with OpenAI Codex CLI to route your OpenAI API requests through JB-Router's intelligent routing system.
...
JB-Router provides the following Codex models:
...
1. Verify your API key is correct in JB-Router dashboard
...
1. Verify the model name matches your JB-Router configuration
2. Check that the OpenAI provider connection is active in JB-Router dashboard
...
Make sure you have configured your API key in the JB-Router cloud dashboard.
