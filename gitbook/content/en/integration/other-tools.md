...
JB-Router is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

JB-Router provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to JB-Router using these settings:

**Local JB-Router:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: any JB-Router model (cc/*, cx/*, glm/*, etc.)
```
...
**Problem:** Cannot connect to JB-Router
```bash
...
- Check network connection to JB-Router
