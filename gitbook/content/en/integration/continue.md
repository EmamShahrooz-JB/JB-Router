...
Integrate JB-Router with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- JB-Router API key from [dashboard](https://YOUR-WORKER.workers.dev/dashboard)
- JB-Router running (local or cloud)
...
### 2. Add JB-Router Model Configuration
...
3. Choose your preferred JB-Router model
...
- Check network latency to JB-Router
