...
Integrate JB-Router with Claude Code CLI to route your Anthropic API requests through JB-Router's intelligent routing system.
...
Claude Code supports the following model aliases that map to JB-Router models:
