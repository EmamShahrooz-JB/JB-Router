...
Integrate JB-Router with Cline VSCode extension to route your AI requests through JB-Router's intelligent routing system.

## Prerequisites

- Visual Studio Code installed
- Cline extension installed from VSCode marketplace
- JB-Router running locally or cloud endpoint configured
...
Set the base URL to your JB-Router endpoint:
...
**Steps:**
1. In the **Base URL** field, enter your JB-Router endpoint
...
3. The key should start with `sk-jbrouter-`

### 5. Select Model

1. In the **Model** dropdown, you can either:
   - Select from available models (if Cline auto-detects them)
   - Manually enter the model name from your JB-Router configuration
...
4. Cline will use JB-Router to process your request

### Code Generation

1. Ask Cline to generate code: "Create a React component for a login form"
2. Cline will generate code using JB-Router
...
3. Get AI-powered explanations through JB-Router

### File Operations

1. Ask Cline to create, modify, or delete files
2. Cline will use JB-Router to understand context and make changes
...
1. Verify JB-Router is running: `curl http://localhost:20128/health`
...
2. Verify your JB-Router instance is running and healthy
3. Try reloading VSCode window (Cmd/Ctrl + Shift + P → "Reload Window")
4. Check JB-Router logs for any errors

## Advanced Configuration

### Using Cloud Endpoint

To use JB-Router cloud endpoint instead of localhost:

1. In Cline settings, set Base URL to: `https://github.com/EmamShahrooz-JB/JB-Router`
2. Make sure you have configured your API key in the JB-Router cloud dashboard
...
## Integration with JB-Router Features

### Model Routing

JB-Router automatically routes your requests to the best available provider based on:
- Model availability
...
If a provider fails, JB-Router automatically falls back to alternative providers configured in your dashboard.

### Usage Tracking

Monitor your Cline usage through JB-Router dashboard:
- Total requests
- Token usage
- Cost per model
