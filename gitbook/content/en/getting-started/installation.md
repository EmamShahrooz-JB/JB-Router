...
Detailed installation guide for JB-Router with troubleshooting tips.
...
Install JB-Router globally to use from anywhere:
...
- ✅ Simple command: `jb-router`
- ✅ Auto-updates with `npm update -g jb-router`
...
3. Data directory created at `~/.jb-router`
...
**Issue:** JB-Router using too much RAM
...
# Delete jb-router-related exports
```
