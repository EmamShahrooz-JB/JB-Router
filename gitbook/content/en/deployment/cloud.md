...
Deploy JB-Router on VPS or Docker for remote access and production use.
...
| `DATA_DIR` | `~/.jb-router` | Database and data storage path |
...
Create `/etc/nginx/sites-available/jb-router`:
