...
Tích hợp JB-Router với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- JB-Router API key từ [dashboard](https://YOUR-WORKER.workers.dev/dashboard)
- JB-Router đang chạy (cục bộ hoặc cloud)
...
### 2. Thêm Cấu hình Model JB-Router
...
3. Chọn model JB-Router ưa thích
...
- Kiểm tra JB-Router đang chạy: `curl http://localhost:20128/health`
...
- Kiểm tra độ trễ network đến JB-Router
