...
Tích hợp JB-Router với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
Chọn từ các model JB-Router có sẵn:
...
### Connection Failed
- Xác minh JB-Router đang chạy: `curl http://localhost:20128/health`
