...
Những câu hỏi phổ biến về JB-Router.

---

## JB-Router là gì?

**JB-Router là bộ định tuyến mô hình AI giúp tối đa hóa giá trị subscription và giảm chi phí.**
...
**JB-Router dùng chiến lược pricing 3 tầng:**
...
## JB-Router có miễn phí không?

**Có, JB-Router hoàn toàn miễn phí và mã nguồn mở 100%.**
...
**Có! Đây là tính năng cốt lõi của JB-Router.**
...
**JB-Router theo dõi quota thời gian thực cho tất cả provider:**
...
## Tôi có thể self-host JB-Router không?

**Có! JB-Router hỗ trợ nhiều tùy chọn deployment:**
...
- `DATA_DIR` - Đường dẫn lưu database (mặc định: `~/.jb-router`)
...
**Có, JB-Router ưu tiên bảo mật và quyền riêng tư:**

**Local storage:**
- Mọi dữ liệu lưu cục bộ tại `~/.jb-router` (hoặc `DATA_DIR` tùy chỉnh)
- Không gửi data đến server JB-Router
...
## Làm thế nào để cập nhật JB-Router?
...
**Breaking changes:**
- Xem [CHANGELOG.md](github.com/EmamShahrooz-JB/JB-Router/blob/main/CHANGELOG.md)
- Backup `~/.jb-router` trước khi update lớn
...
Xem [CONTRIBUTING.md](github.com/EmamShahrooz-JB/JB-Router/blob/main/CONTRIBUTING.md) để biết chi tiết.
