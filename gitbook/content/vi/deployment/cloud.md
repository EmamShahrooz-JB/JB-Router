...
Triển khai JB-Router trên VPS hoặc Docker để truy cập từ xa và dùng trong production.
...
| `DATA_DIR` | `~/.jb-router` | Đường dẫn lưu database và data |
...
Tạo `/etc/nginx/sites-available/jb-router`:
...
# If NOT using reverse proxy, allow JB-Router ports
