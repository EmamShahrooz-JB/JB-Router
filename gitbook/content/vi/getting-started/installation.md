...
Hướng dẫn cài đặt chi tiết cho JB-Router với mẹo troubleshooting.
...
Cài JB-Router toàn cục để dùng ở bất kỳ đâu:
...
**Lợi ích:**
- ✅ Chạy từ mọi thư mục
- ✅ Lệnh đơn giản: `jb-router`
- ✅ Auto-update với `npm update -g jb-router`
...
3. Data directory được tạo tại `~/.jb-router`
...
**Vấn đề:** JB-Router dùng quá nhiều RAM
