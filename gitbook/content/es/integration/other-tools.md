...
JB-Router es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

JB-Router proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a JB-Router usando estas configuraciones:

**JB-Router local:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de JB-Router (cc/*, cx/*, glm/*, etc.)
```

**JB-Router en la nube:**
```
...
**Problema:** No se puede conectar a JB-Router
```bash
# Verifica si JB-Router está corriendo
...
**Solución:**
- Verifica que JB-Router esté corriendo
...
- Verifica la conexión de red a JB-Router
