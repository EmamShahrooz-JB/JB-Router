...
Integra JB-Router con Claude Code CLI para enrutar tus solicitudes de la API de Anthropic a través del sistema de enrutamiento inteligente de JB-Router.
...
Claude Code soporta los siguientes aliases de modelos que mapean a modelos de JB-Router:
...
```bash
export ANTHROPIC_BASE_URL="https://github.com/EmamShahrooz-JB/JB-Router"
```
