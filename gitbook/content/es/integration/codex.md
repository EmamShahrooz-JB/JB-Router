...
Integra JB-Router con OpenAI Codex CLI para enrutar tus solicitudes de la API de OpenAI a través del sistema de enrutamiento inteligente de JB-Router.
...
JB-Router proporciona los siguientes modelos de Codex:
...
1. Verifica que tu API key sea correcta en el dashboard de JB-Router
...
1. Verifica que el nombre del modelo coincida con tu configuración de JB-Router
2. Verifica que la conexión del proveedor de OpenAI esté activa en el dashboard de JB-Router
...
```bash
export OPENAI_BASE_URL="https://github.com/EmamShahrooz-JB/JB-Router"
```

Asegúrate de haber configurado tu API key en el dashboard en la nube de JB-Router.
