...
Preguntas comunes sobre JB-Router.

---

## ¿Qué es JB-Router?

**JB-Router es un router de modelos de IA que maximiza el valor de tu suscripción y minimiza los costos.**
...
**JB-Router usa una estrategia de precios de 3 niveles:**
...
**Sí, JB-Router en sí es 100% gratis y open source.**
...
**¡Sí! Esta es la característica principal de JB-Router.**
...
**JB-Router rastrea la cuota en tiempo real para todos los proveedores:**
...
## ¿JB-Router funciona con Cursor?

**Sí, pero Cursor requiere un endpoint en la nube.**

**Problema:** Cursor IDE no soporta endpoints en localhost.

**Solución:** Usa el despliegue en la nube de JB-Router:

```
Cursor Settings → Models → Advanced:
  OpenAI API Base URL: https://YOUR-WORKER.workers.dev/v1
...
## ¿Puedo auto-hospedar JB-Router?

**¡Sí! JB-Router soporta múltiples opciones de despliegue:**
...
- `DATA_DIR` - Ruta de almacenamiento de la base de datos (por defecto: `~/.jb-router`)
...
**Sí, JB-Router prioriza la seguridad y privacidad:**

**Almacenamiento local:**
- Todos los datos se almacenan localmente en `~/.jb-router` (o `DATA_DIR` personalizado)
- No se envían datos a los servidores de JB-Router
...
**Cambios disruptivos:**
- Revisa [CHANGELOG.md](github.com/EmamShahrooz-JB/JB-Router/blob/main/CHANGELOG.md)
- Respalda `~/.jb-router` antes de actualizaciones mayores
...
1. **Reportar bugs:**
   - [GitHub Issues](github.com/EmamShahrooz-JB/JB-Router/issues)
   - Incluye logs de error, pasos para reproducir

2. **Solicitar características:**
   - [GitHub Discussions](github.com/EmamShahrooz-JB/JB-Router/discussions)
   - Describe el caso de uso y los beneficios

3. **Enviar código:**
   ```bash
   # Fork del repo
   git clone https://github.com/YOUR_USERNAME/jb-router.git
   cd jb-router
...
Consulta [CONTRIBUTING.md](github.com/EmamShahrooz-JB/JB-Router/blob/main/CONTRIBUTING.md) para detalles.

---

## ¿Necesitas más ayuda?

- **Documentación:** [jb-router.com/docs](https://github.com/EmamShahrooz-JB/JB-Router#documentation)
