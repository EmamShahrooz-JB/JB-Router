...
JB-RouterをClaude Code CLIと統合し、AnthropicのAPIリクエストをJB-Routerのインテリジェントルーティングシステム経由でルーティングします。
...
Claude CodeはJB-Routerモデルにマッピングされる以下のモデルエイリアスをサポート:
