...
export const GITHUB_CONFIG = {
  changelogUrl: "https://raw.githubusercontent.com/EmamShahrooz-JB/JB-Router/refs/heads/master/CHANGELOG.md",
  donateUrl: "https://github.com/EmamShahrooz-JB/JB-Router",
};

// Updater configuration
export const UPDATER_CONFIG = {
  npmPackageName: "jb-router",
  installCmd: "npm i -g jb-router",
  installCmdLatest: "npm i -g jb-router@latest --prefer-online",
