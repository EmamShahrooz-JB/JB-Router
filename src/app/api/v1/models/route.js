...
// and break recursive loops between jb-router instances connected to each other.
const INTERNAL_MODELS_FETCH_HEADER = "x-jb-router-internal-models-fetch";
...
export async function buildModelsList(kindFilter, options = {}) {
  ...
  // jb-router instance's fetchCompatibleModelIds — skip dynamic fetch to break
...
export async function GET(request) {
  try {
    // Detect cross-instance recursive /models fetch (another jb-router fetching our /models)
