...
import { ANTIGRAVITY_CONFIG, GEMINI_CONFIG, ZED_HOSTED_CONFIG } from "@/lib/oauth/constants/oauth";
...
const PROVIDER_MODELS_CONFIG = {
  ...
  antigravity: {
    customResolver: async (connection) => resolveAntigravityModels(connection, {
      proxyOptions: await resolveConnectionProxyConfig(connection.providerSpecificData),
      refreshCredentials: (conn) => refreshGoogleToken(conn.refreshToken, ANTIGRAVITY_CONFIG.clientId, ANTIGRAVITY_CONFIG.clientSecret),
