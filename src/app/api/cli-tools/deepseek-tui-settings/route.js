...
// Build TOML config for JB-Router (openai provider mode)
const buildJbRouterConfig = (baseUrl, apiKey, model) => {
...
// Detect JB-Router by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildJbRouterConfig(baseUrl, apiKey || "sk_jbrouter", model);
