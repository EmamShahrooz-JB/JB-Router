...
import SelectMenuEnhancer from "@/shared/components/SelectMenuEnhancer";
...
export const metadata = {
  title: "JB-Router - AI Infrastructure Management",
    ...
    <html lang="en" suppressHydrationWarning>
      ...
      <body className={`${inter.variable} font-sans antialiased`}>
        <ThemeProvider>
          ...
          {/* Styles every native <select> popup across the app (dashboard, login,
              landing): glass panel, search, keyboard navigation, dark-mode safe. */}
          <SelectMenuEnhancer />
        </ThemeProvider>
