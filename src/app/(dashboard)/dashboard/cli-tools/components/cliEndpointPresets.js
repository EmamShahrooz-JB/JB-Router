...
const endpoints = createStore({
  storageKey: "jb-router.cliToolEndpointPresets",
  changeEvent: "jb-router:endpoint-presets-changed",
  itemField: "baseUrl",
...
const apiKeys = createStore({
  storageKey: "jb-router.cliToolApiKeyPresets",
  changeEvent: "jb-router:api-key-presets-changed",
  itemField: "key",
});
